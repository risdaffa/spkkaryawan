...
?>
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<p><a href="edit-user.php?id=<?php echo $id_user; ?>" class="button">Edit</a> &nbsp; <a href="hapus-user.php?id=<?php echo $id_user; ?>" class="button button-red yaqin-hapus">Hapus</a></p>
